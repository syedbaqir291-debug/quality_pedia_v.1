...
const STANDARD_REF_MAP = {
  'Basic Quality Tools (7 QC)':        ['ISO 9001:2015 – Clause 9.1 (Monitoring, Measurement, Analysis)', 'JCI QPS Chapter – Data Collection & Analysis'],
  'Improvement Methodologies':         ['ISO 9001:2015 – Clause 10 (Improvement)', 'JCI QPS Chapter', 'IHI Model for Improvement'],
  'Risk Management & Patient Safety':  ['JCI International Patient Safety Goals (IPSG)', 'ISO 31000 – Risk Management Guidelines'],
  'Statistical & Measurement Tools':   ['ISO 9001:2015 – Clause 9.1', 'JCI QPS Chapter – Statistical Analysis'],
  'Process Analysis Tools':            ['ISO 9001:2015 – Clause 8 (Operation)', 'Lean Enterprise Institute Principles'],
  'Lean Tools':                        ['Toyota Production System Principles', 'ISO 9001:2015 – Clause 8'],
  'Audit & Compliance Tools':          ['ISO 19011 – Auditing Management Systems', 'JCI Accreditation Standards'],
  'Strategic & Management Frameworks': ['ISO 9001:2015 – Clause 5–6 (Leadership & Planning)', 'Balanced Scorecard Institute Framework'],
  'Healthcare-Specific QA/QI':         ['JCI International Patient Safety Goals (IPSG)', 'WHO Patient Safety Curriculum'],
  'Project & Team Management Tools':   ['ISO 9001:2015 – Clause 5.3 (Roles & Responsibilities)', 'PMI PMBOK Guide'],
};
...
function enrichTools(){
  TOOLS.forEach(t=>{
    ...
    t.standardRefs = STANDARD_REF_MAP[t.cat] || [];
